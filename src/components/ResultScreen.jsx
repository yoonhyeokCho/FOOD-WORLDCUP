    ...
    >
      ...
      <div className="relative z-10 text-center text-white">
        ...
        >
          <button
            onClick={handleShare}
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-xl rounded-full font-bold shadow-2xl flex items-center gap-2 justify-center"
          >
          ...
          <button
            onClick={onRestart}
            className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 text-xl rounded-full font-bold shadow-2xl flex items-center gap-2 justify-center"
          >
